...
def generate_composed_sdg(slither_obj, generated_sdg, vrg, graph_dir, sdg_objects, call_heuristic, owner_only_modifiers,
    ...
    for function in functions_to_be_analyzed.keys():
        ...
        if is_ether_sending is True or is_ext_call is True:
            ...
            # composed_graph = composed_sdg[function]._dao_composed_sdgs
            # for function_2 in composed_graph[function].keys():
            #     composed_graph_list = composed_graph[function][function_2]
            #     sdg_objects[function].sdg = composed_graph_list[0][0]
            #     composed_sdg[function] = Compose(slither_obj, functions_to_be_analyzed[function], sdg_objects,
            #                                      is_ext_call,
            #                                      is_ether_sending, owner_only_functions, target_contracts, graph_dir,
            #                                      dump_graph, dao, tod, log)
