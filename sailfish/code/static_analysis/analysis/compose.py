...
class Compose:
                ...
                if type(instr).__name__ == 'LowLevelCall' or type(instr).__name__ == 'HighLevelCall':
                    ...
                    for matching_sdg_obj in all_sdgs:
                        if matching_sdg_obj._function == self._sdg_obj._function:
                            ...
                            matching_sdg_1_root_nodes = self.get_root_nodes(matching_sdg)
                            matching_sdg_1_leaf_nodes = self.get_leaf_nodes(matching_sdg)

                        else:
                            matching_sdg = matching_sdg_obj._sdg
                            matching_sdg_1_root_nodes = matching_sdg_obj._root_nodes
                            matching_sdg_1_leaf_nodes = matching_sdg_obj._leaf_nodes
                        for matching_sdg_obj_2 in all_sdgs:
                            matching_sdg_2 = copy.deepcopy(matching_sdg_obj_2._sdg)
                            matching_sdg_2_root_nodes = self.get_root_nodes(matching_sdg_2)
                            matching_sdg_2_leaf_nodes = self.get_leaf_nodes(matching_sdg_2)

                            function_1_start = "Enter - " + matching_sdg_obj._function.name
                            function_1_end = "End - " + matching_sdg_obj._function.name
                            function_2_end = "End - " + matching_sdg_obj_2._function.name
                            function_2_start = "Enter - " + matching_sdg_obj_2._function.name


                            composed_sdg_2 = nx.compose(matching_sdg_2, matching_sdg)

                            self.add_src_to_dest_edges(composed_sdg_2, matching_sdg_2_leaf_nodes, matching_sdg_1_root_nodes, function_2_end + ", " + function_1_start)

                            composed_sdg = nx.compose(modified_sdg, composed_sdg_2)

                            self.remove_edges(composed_sdg, [graph_node], successors)

                            self.add_src_to_dest_edges(composed_sdg, [graph_node], matching_sdg_2_root_nodes, function_2_start)
                            self.add_src_to_dest_edges(composed_sdg, matching_sdg_1_leaf_nodes, successors, function_1_end)

                            composed_sdgs[self._sdg_obj._function][matching_sdg_obj._function].append(
                                (composed_sdg, graph_node, modified_sdg, composed_sdg_2, matching_sdg_obj, matching_sdg_obj_2))
                            # print(len(composed_sdgs[self._sdg_obj._function][matching_sdg_obj._function]))
                            composed_sdg_to_call_predecessors[composed_sdg] = copy.copy(self._all_predecessors)
                            self._dao_composed_sdg_details[self._sdg_obj._function][matching_sdg_obj._function] = (
                            modified_sdg, composed_sdg_2)
    ...
    def build_composed_sdg(self, target_sdg, sdg_obj, sdg_objects):
        ...
        if True or self.dao is True and self._is_ext_call is True:
